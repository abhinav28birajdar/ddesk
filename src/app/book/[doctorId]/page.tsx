...
function BookingFlowContent({ doctorId }: { doctorId: string }) {
...
export default function BookingFlowPage({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans">
      <Navbar />
      <Suspense fallback={<div className="p-12 text-center text-sm font-semibold text-slate-500">Loading booking portal...</div>}>
        <BookingFlowContent doctorId={doctorId} />
      </Suspense>
      <Footer />
    </div>
  );
